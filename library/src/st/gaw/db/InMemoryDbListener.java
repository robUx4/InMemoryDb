...
/**
 * listener interface to be notified when the data changes in a {@link InMemoryDbHelper}
 *
 * @param <E> the type of data stored by the database
 */
public interface InMemoryDbListener<E> {
	/**
	 * notify the listener that the data of the {@link InMemoryDbHelper} just changed
