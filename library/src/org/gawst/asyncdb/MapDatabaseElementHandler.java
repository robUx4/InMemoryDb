 ...
 *
 * @param <K> Type of the Key read/write from the {@link org.gawst.asyncdb.DatabaseSource} to/from the {@code Map} storage.
 * @param <V> Type of the Value read/write from the {@link org.gawst.asyncdb.DatabaseSource} to/from the {@code Map} storage.
 * @author Created by robUx4 on 06/01/2015.
 * @see org.gawst.asyncdb.DatabaseElementHandler
 */
